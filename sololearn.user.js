...
(function() {
     'use strict';
     GM_addStyle('nav.sl-navbar, nav.light, ul.sl-navbar__content-list, div.sl-courses-catalog-dropdown, li.sl-courses-catalog-dropdown__item, li.selected, header.le-lesson-header, footer.le-lesson-footer, footer.le-lesson-footer.grey { background-color: #303030; color: #FFFFFF; }');
     GM_addStyle('span.sl-user-streak__streakDay, span.sl-user-heart__heart-count, div.sl-navigation-actions__bits  { color: #FFFFFF; }');
