...
(function() {
    ...
    GM_addStyle('div.pos-relative.h-full.flex-wrap.rounded-b-xl.bg-white.pt-1, div[data-v-e53fab36][data-v-688aab3c].flex.w-full.flex-col, div[data-v-45a9c69a].composer-container.pos-relative.flex.h-full.min-w-0.flex-col.bg-white { background-color: #252525; color: #FFFFFF; }');
