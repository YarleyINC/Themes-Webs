// ==UserScript==
// @name         Dark Mode | sololearn
// @version      2025-04-02
// @description  Dark Mode Theme for SoloLearn
// @author       @YarleyINC
...
(function() {
     ...
     GM_addStyle('div.sl-streak, .le-course-container,div.sl-courses-catalog-dropdown__expand, div.le-lesson, div.sl-complete-celebration__container, div.sl-complete-celebration__footer, div.sol-summary.has-actionBar, div.sol-summary_content{ background-color: #565656; color: #FFFFFF; }');
     ////TITULOS O TEXTOS
     //Titulos o textos de importancia
     GM_addStyle('div.streak-info__content,div.le-quiz-feedback__text, div.sl-complete-celebration__title, span.sl-user-streak__streakDay, span.sl-user-heart__heart-count, div.sl-navigation-actions__bits  { color: #FFFFFF; }');
     //Subtitulos 
     GM_addStyle('div.week-day, div.streak-info-header { color: #dddddd; }');
     //Cuando es necesario
